...
urlpatterns = [
    ...
    path("dashboard/guests/add/", views.dashboard_add_guest_view, name="dashboard-add-guest"),
    path("dashboard/export/rsvps.csv", views.dashboard_export_rsvps_csv_view, name="dashboard-export-rsvps"),
